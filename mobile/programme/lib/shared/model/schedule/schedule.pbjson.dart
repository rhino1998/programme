...
const Task$json = const {
  ...
  '2': const [
    ...
    const {'1': 'start_null', '3': 10, '4': 1, '5': 8, '9': 0, '10': 'startNull'},
    const {'1': 'start_value', '3': 11, '4': 1, '5': 3, '9': 0, '10': 'startValue'},
    const {'1': 'travel_method_null', '3': 12, '4': 1, '5': 8, '9': 1, '10': 'travelMethodNull'},
    const {'1': 'travel_method_value', '3': 13, '4': 1, '5': 14, '6': '.shared.model.routes.TravelMethod', '9': 1, '10': 'travelMethodValue'},
    const {'1': 'location_null', '3': 14, '4': 1, '5': 8, '9': 2, '10': 'locationNull'},
    const {'1': 'location_value', '3': 15, '4': 1, '5': 11, '6': '.shared.model.routes.Location', '9': 2, '10': 'locationValue'},
  ],
  '8': const [
    const {'1': 'start'},
